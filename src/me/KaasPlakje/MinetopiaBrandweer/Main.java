...
//REGISTER COMMANDS
  ...
  public Sneeuwballen getS() { return this.s; }
  ...
  public void addSnowball(Snowball b) { this.s.addSnowball(b); }


  
  public void removeSnowball(Snowball b) { this.s.removeSnowball(b); }
